...
const ROUTES_CONFIG = [
  ...
  {
    path: "/gioi-thieu/",
    children: ["/lich-su/", "/co-so-vat-chat/"],
  },
  {
    path: "/dai-hoc/",
    children: ["/dai-hoc-nganh-hoc/"],
  },
  {
    path: "/thac-si/",
    children: ["/thac-si-nganh-hoc/"],
  },
  {
    path: "/tien-si/",
    children: ["/tien-si-nganh-hoc/"],
  },
  {
    path: "/quoc-te/",
    children: [],
  },
  {
    ...
    children: ["/doi-song-sinh-vien-chi-tiet/"],
  },
  {
    path: "/tin-tuyen-sinh/",
    children: [
      ...
      "/dktv-tuyen-sinh/",
      "/tra-cuu-tuyen-sinh/",
      "/tra-cuu-tuyen-sinh/ket-qua/",
    ],
  },
  {
    path: "/danh-muc-thong-bao/",
    children: ["/danh-muc-thong-bao-chi-tiet/"],
  },
  {
    path: "/su-kien/",
    children: ["/su-kien-chi-tiet/"],
  },
];
...
const NAVBAR_MENU = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Tra cứu kết quả tuyển sinh",
